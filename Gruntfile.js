		...
		browserify: {
			dist: {
				files: {
					...
					'dist/sp-quality/sp-quality.js': 'src/sp-quality/sp-quality.js',
		...
		postcss: {
			uncompressed: {
				...
				files: {
					...
					'dist/sp-quality/sp-quality.css': 'src/sp-quality/sp-quality.css',
			...
			compressed: {
				...
				files: {
					...
					'dist/sp-quality/sp-quality.min.css': 'dist/sp-quality/sp-quality.css',
